...
const SPIKE_FILE = path.join(ROOT, 'artefacts', 'archived', '2026-04-19-skills-platform-phase4', 'spikes', 'spike-b1-output.md');
...
const ENF_MCP    = path.join(ROOT, 'artefacts', 'archived', '2026-04-19-skills-platform-phase4', 'stories', 'p4-enf-mcp.md');
