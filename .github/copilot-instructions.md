...
**Injectable adapter rule (D37):** When a story introduces an injectable adapter (`let _x = defaultFn; function setX(fn) { _x = fn; }`), three things are mandatory — not optional:
