...
**Response type:** artefact — the correct output is always a DoD verification result, never a clarification question

> **Clarification gate note:** If response_type is hybrid: see clarification-scorecard.md for the CL1-CL4 rubric. D1-D7 must not be applied to clarification responses. (Not applicable to /definition-of-done — this skill always produces artefact output.)
