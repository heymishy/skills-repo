...
I want **to create a pod — a named team with members and their roles — and have it persisted in the system**,
So that **I have a reusable team definition that can later be assigned to products**.
## Benefit Linkage
