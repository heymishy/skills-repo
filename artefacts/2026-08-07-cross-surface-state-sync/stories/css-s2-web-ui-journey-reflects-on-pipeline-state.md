...
- **Upstream:** css-s1 (reuses its slug-correlation and journey/feature-lookup mechanism), `das-s1` (reuses its GitHub Contents API commit pattern directly). `[External: das-s1 lives in a different feature folder — implemented, PR #674 open pending merge, blocked on a GitHub Actions platform outage as of 2026-08-07 — confirmed by operator on 2026-08-07]`
