...
function renderStageDots(stage) {
  ...
  return '<div class="sw-stagedots">' + dots + '</div>';
}
...
function renderFeaturesList(data) {
  ...
  if (features.length === 0) {
    return [
      '<div class="sw-empty">',
        ...
        '<h1>No features yet in this workspace.</h1>',
  ...
  return [
    ...
    '<div class="sw-feat">',
      ...
      '<div class="sw-ftable">',
        '<div class="sw-fhead"><span>Feature</span><span>Pipeline</span><span>Owner</span><span>Updated</span><span style="text-align:right">Artefacts</span></div>',
        rows,
      '</div>',
