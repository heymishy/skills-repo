...
function renderChat(data) {
  ...
  (data.priorQA || []).forEach(function(qa, i) {
    messages.push(
      '<div class="sw-chat-msg sw-chat-msg--assistant">' +
  ...
  return [
    ...
    '<div class="sw-chat">',
      ...
      '<section class="sw-chat-pane">',
        ...
        '</header>',
        '<div class="sw-chat-thread">' + messages.join('') + '</div>',
        '<footer class="sw-chat-foot">',
          confirmBanner,
          '<form method="POST" action="' + formAction + '" id="answerForm">',
            '<div class="sw-chat-input">',
              '<textarea name="answer" placeholder="Type your answer…" autofocus></textarea>',
    ...
    '<script>',
      'document.addEventListener("keydown",function(e){',
        'if((e.metaKey||e.ctrlKey)&&e.key==="Enter"){',
          'var f=document.getElementById("answerForm");if(f)f.submit();',
        '}',
      '});',
    '</script>'
  ].join('');
