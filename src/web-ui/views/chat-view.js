...
function renderChat(data) {
  ...
  return [
    ...
    '<div class="sw-chat">',
      ...
      // RIGHT: live draft (three sections: condition items + assumption cards + canvas)
      '<section class="sw-chat-pane" style="display:flex;flex-direction:column">',
        ...
        '<div class="ac-section-head">',
          ...
          '</div>',
        '</div>',
        '<div id="assumption-cards" role="region" aria-label="Assumption cards" style="flex:0 0 auto;max-height:40%;overflow-y:auto;padding:10px 12px;border-bottom:1px solid var(--line);display:flex;flex-direction:column;gap:6px">',
