...
function renderFeaturesList(data) {
  ...
  return [
    '<style>',
      ...
      '.sw-feat-head { margin-bottom: 24px; display: flex; align-items: flex-start; justify-content: space-between; gap: 16px; flex-wrap: wrap; }',
      '.sw-feat-head-text { flex: 1; }',
      '.sw-view-toggle { display: flex; gap: 6px; align-items: center; padding-top: 4px; }',
      '.sw-toggle-btn { padding: 5px 10px; border-radius: 5px; background: transparent; border: 1px solid var(--line); color: var(--muted); cursor: pointer; font: inherit; font-size: 13px; text-decoration: none; display: inline-flex; align-items: center; gap: 4px; }',
      '.sw-toggle-btn:hover { background: var(--surface); color: var(--ink); }',
      '.sw-toggle-btn--active { background: var(--surface); border-color: var(--line-2); color: var(--ink); font-weight: 500; cursor: default; }',
    ...
    '<div class="sw-feat">',
      '<header class="sw-feat-head">',
        ...
        '<div class="sw-view-toggle">',
          '<a class="sw-toggle-btn sw-toggle-btn--active" href="/features" aria-current="page">☰ List</a>',
          '<a class="sw-toggle-btn" href="/features?view=board">⊞ Board</a>',
        '</div>',
      '</header>',
