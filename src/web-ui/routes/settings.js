...
var _posthog = require('../modules/posthog-server'); // si-s2 (AC6) -- same plain-module capture() convention as team-management.js/team-invitations.js, not a D37 adapter (posthog-server.js has no setter/getter pair)
