...
// spliced in here too, once at module init, alongside the static-file read --
// only the per-request CSRF token substitution (below, in handleRoot) needs
// to happen per request.
