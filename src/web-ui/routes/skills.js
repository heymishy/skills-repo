...
function _renderChatPage(skillName, sessionId, session) {
  ...
  var script = [
    ...
    '      bar.style.cssText = "padding:8px 16px;background:var(--warn-bg,#fff3cd);border:1px solid var(--warn,#ffc107);border-radius:4px;margin:8px 16px";',
    ...
    '      reviewBtn.style.cssText = "margin-left:12px;font-size:13px";',
