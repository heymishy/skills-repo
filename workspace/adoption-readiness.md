...
| MM4 | Estimation calibration accuracy — ±20% at E2 vs actual | 🟡 Amber | estimation-norms.md and results.tsv seeded with Phase 1 and Phase 2 norms entries. ±20% confidence requires a minimum of three completed features with E2+actual pairs. Phase 1 and Phase 2 = 2 features only. | Closes at Phase 3 /improve when the third feature's actuals are ingested. Until then, estimates carry a ±40% error bound and should be disclosed as such to Westpac. |
