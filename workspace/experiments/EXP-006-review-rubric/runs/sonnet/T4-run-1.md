# /review — Corpus Case T4 — Staff Report Export: MEDIUM + LOW findings only — Trial 1
...
### 1-M1 — MEDIUM — Category D (Completeness) — Story S1.3: NFR section is blank; discovery performance requirement not carried forward
...
### 1-L1 — LOW — Category C (AC quality) — Story S2.1: AC2 is functional but underprecise
...
### 1-L2 — LOW — Category D (Completeness) — Story S2.2: Estimated effort field is blank
