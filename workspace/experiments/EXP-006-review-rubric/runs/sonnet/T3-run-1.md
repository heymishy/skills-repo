# /review — Corpus Case T3 — Card Experience API: Scope integrity (HIGH) — Trial 1
...
### 1-H1 — HIGH — Category B (Scope integrity) — Stories S5 and S6: implement features explicitly deferred in the discovery out-of-scope section
