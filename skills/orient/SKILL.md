...
> **This looks like Entry C**  a no-history brownfield repo: the project exists and has been operated, but no delivery pipeline artefacts or application logic exist to route through Entry A or Entry B. Use `templates/retrospective-story.md` to document any work already delivered before the pipeline was adopted.
...
1. Use the `templates/retrospective-story.md` template to create retroactive story artefacts for any work already delivered.
